...
class AsyncAbstractSessionStorage(ABC):
    def __init__(self):
        pass

    @abstractmethod
    async def get_public_hash(self) -> typing.Optional[str]:
        """
    ...
    @abstractmethod
    async def get_private_hash(self) -> typing.Optional[str]:
        """
    ...
    @abstractmethod
    async def get_session_id(self) -> typing.Optional[str]:
        """
    ...
    @abstractmethod
    async def get_session_challenge(self) -> typing.Optional[str]:
        """
    ...
    @abstractmethod
    async def set_public_hash(self, public_hash: str):
        """
    ...
    @abstractmethod
    async def set_private_hash(self, private_hash: str):
        """
    ...
    @abstractmethod
    async def set_session_challenge(self, session_challenge: str):
        """
