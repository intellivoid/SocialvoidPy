...
class Network:
    ...
    @async_auto_create_session
    async def get_peer(self, peer: typing.Union[types.Peer, str]) -> types.Peer:
        """
    ...
    async def get_profile(
        ...
        **Authentication Required:** Yes
        ...
        if peer:
            params["peer"] = peer
        resp = (
            await self._sv.make_request(Request("network.get_profile", params))
        ).unwrap()
    ...
    async def get_followers(
        ...
        **Authentication Required:** Yes
        ...
        if peer:
            params["peer"] = peer
        resp = (
            await self._sv.make_request(Request("network.get_followers", params))
        ).unwrap()
    ...
    async def get_following(
        ...
        **Authentication Required:** Yes
        ...
        if peer:
            params["peer"] = peer
        resp = (
            await self._sv.make_request(Request("network.get_following", params))
        ).unwrap()
        return [types.Peer.from_json(i) for i in resp]
    ...
    async def iter_followers(
        ...
        start_page: int = 1,
    ) -> typing.AsyncIterator[types.Peer]:
        """
        ...
        **Authentication Required:** Yes
        ...
        page = start_page
        while True:
            peers = await self.get_followers(peer, page)
            for i in peers:
                yield i
    ...
    async def iter_following(
        ...
        **Authentication Required:** Yes
        ...
        page = start_page
        while True:
            peers = await self.get_following(peer, page)
            for i in peers:
                yield i
